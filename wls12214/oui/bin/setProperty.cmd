...
SET PLATFORM_NAME=NT_AMD64

SET JAVA_HOME_LOCATION=C:\Program Files\Java\jdk-1.8
...
@REM must allow -oracleHome to be overridden on the command line.
@REM Last -oracleHome option overrides previous settings.
"%JRELOC%\bin\java.exe" %JVM_ARGS% -classpath %JAR% %MAIN_CLASS% -oracleHome %OHOME% %ALLARGS%
