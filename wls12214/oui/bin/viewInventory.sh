...
PLATFORM_NAME="NT_AMD64"

JAVA_HOME_LOCATION="C:\Program Files\Java\jdk-1.8"
...
# fail if executed as ". viewInventory.sh"
...
"$JRELOC/bin/$AOUT" $JVM_ARGS $JAVA_OPTIONS -classpath "$JAR" com.oracle.cie.gdr.tools.InventoryDump "$@"
